...
tail -f $REPO/gem5/m5out/board.pc.com_1.device
...
watch -n 5 'grep "simSeconds" $REPO/gem5/m5out/stats.txt 2>/dev/null | head -2'
...
```bash
# Recompute every figure quoted in the README and the paper from the v3 logs
